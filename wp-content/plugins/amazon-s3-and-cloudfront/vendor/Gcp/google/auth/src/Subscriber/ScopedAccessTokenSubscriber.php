 ...
 */
namespace DeliciousBrains\WP_Offload_Media\Gcp\Google\Auth\Subscriber;

use DeliciousBrains\WP_Offload_Media\Gcp\Google\Auth\CacheTrait;
use DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Event\BeforeEvent;
use DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Event\RequestEvents;
use DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Event\SubscriberInterface;
 ...
 */
class ScopedAccessTokenSubscriber implements \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Event\SubscriberInterface
{
    use CacheTrait;
    ...
    {
        return ['before' => ['onBefore', \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Event\RequestEvents::SIGN_REQUEST]];
    }
    /**
     ...
     */
    public function onBefore(\DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Event\BeforeEvent $event)
    {
