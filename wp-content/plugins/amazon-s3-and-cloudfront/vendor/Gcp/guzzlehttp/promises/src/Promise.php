 ...
 */
class Promise implements \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Promise\PromiseInterface
{
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        if ($this->state === self::PENDING) {
            $p = new \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Promise\Promise(null, [$this, 'cancel']);
    ...
    public function cancel()
    {
        ...
        if ($this->state === self::PENDING) {
            $this->reject(new \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Promise\CancellationException('Promise has been cancelled'));
        }
    }
