...
use DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Exception\BadResponseException;
use DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Exception\TooManyRedirectsException;
...
class RedirectMiddleware
{
    ...
    private function guardMax(\DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\RequestInterface $request, array &$options)
    {
        ...
        if ($options['__redirect_count'] > $max) {
            throw new \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Exception\TooManyRedirectsException("Will not follow more than {$max} redirects", $request);
        }
    }
    /**
     * @param RequestInterface  $request
     ...
     */
    public function modifyRequest(\DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\RequestInterface $request, array $options, \DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\ResponseInterface $response)
    {
        ...
        return \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Psr7\modify_request($request, $modify);
    }
    /**
     ...
     * @return UriInterface
     */
    private function redirectUri(\DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\RequestInterface $request, \DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\ResponseInterface $response, array $protocols)
    {
