...
final class EasyHandle
{
    ...
    public function createResponse()
    {
        ...
        $headers = \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\headers_from_lines($this->headers);
        ...
        $this->response = new \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Psr7\Response($startLine[1], $headers, $this->sink, substr($startLine[0], 5), isset($startLine[2]) ? (string) $startLine[2] : null);
    }
