...
class RetryMiddleware
{
    ...
    private function onFulfilled(\DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\RequestInterface $req, array $options)
    {
    ...
    private function onRejected(\DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\RequestInterface $req, array $options)
    {
    ...
    private function doRetry(\DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\RequestInterface $request, array $options, \DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\ResponseInterface $response = null)
    {
