 ...
 */
class RequestException extends \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Exception\TransferException
{
    ...
    public function __construct($message, \DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\RequestInterface $request, \DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\ResponseInterface $response = null, \Exception $previous = null, array $handlerContext = [])
    {
     ...
     */
    public static function wrapException(\DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\RequestInterface $request, \Exception $e)
    {
     ...
     * @return self
     */
    public static function create(\DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\RequestInterface $request, \DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\ResponseInterface $response = null, \Exception $previous = null, array $ctx = [])
    {
        if (!$response) {
