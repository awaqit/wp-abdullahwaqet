...
class CurlFactory implements \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Handler\CurlFactoryInterface
{
     ...
     */
    public static function finish(callable $handler, \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Handler\EasyHandle $easy, \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Handler\CurlFactoryInterface $factory)
    {
    ...
    private static function createRejection(\DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Handler\EasyHandle $easy, array $ctx)
    {
    ...
    private function getDefaultConf(\DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Handler\EasyHandle $easy)
    {
    ...
    private function applyMethod(\DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Handler\EasyHandle $easy, array &$conf)
    {
    ...
    private function applyBody(\DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\RequestInterface $request, array $options, array &$conf)
    {
    ...
    private function applyHeaders(\DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Handler\EasyHandle $easy, array &$conf)
    {
    ...
    private function applyHandlerOptions(\DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Handler\EasyHandle $easy, array &$conf)
    {
        ...
        if (isset($options['sink'])) {
            ...
            $easy->sink = \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Psr7\stream_for($conf[CURLOPT_FILE]);
        }
        ...
        if (isset($options['proxy'])) {
            if (!is_array($options['proxy'])) {
                ...
                if (isset($options['proxy'][$scheme])) {
                    ...
                    if (!isset($options['proxy']['no']) || !\DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\is_host_in_noproxy($host, $options['proxy']['no'])) {
        ...
        if (!empty($options['debug'])) {
            $conf[CURLOPT_STDERR] = \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\debug_resource($options['debug']);
     ...
     */
    private static function retryFailedRewind(callable $handler, \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Handler\EasyHandle $easy, array $ctx)
    {
        try {
    ...
    private function createHeaderFn(\DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Handler\EasyHandle $easy)
    {
