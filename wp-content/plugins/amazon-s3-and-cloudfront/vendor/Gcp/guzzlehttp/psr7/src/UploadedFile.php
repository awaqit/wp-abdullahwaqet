...
class UploadedFile implements \DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Message\UploadedFileInterface
{
    /**
     * @var int[]
     */
    ...
    private function setStreamOrFile($streamOrFile)
    {
        if (is_string($streamOrFile)) {
            ...
            $this->stream = new \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Psr7\Stream($streamOrFile);
    ...
    public function getStream()
    {
        ...
        return new \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Psr7\LazyOpenStream($this->file, 'r+');
    }
    /**
     * {@inheritdoc}
     *
