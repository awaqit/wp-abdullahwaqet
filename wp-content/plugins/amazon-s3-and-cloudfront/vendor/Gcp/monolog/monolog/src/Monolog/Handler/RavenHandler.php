 ...
 */
class RavenHandler extends \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function setBatchFormatter(\DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Formatter\FormatterInterface $formatter)
    {
    ...
    {
        return new \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Formatter\LineFormatter('[%channel%] %message%');
    }
    /**
