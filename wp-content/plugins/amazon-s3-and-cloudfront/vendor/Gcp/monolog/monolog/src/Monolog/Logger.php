...
class Logger implements \DeliciousBrains\WP_Offload_Media\Gcp\Psr\Log\LoggerInterface, \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\ResettableInterface
{
     ...
     * @return $this
     */
    public function pushHandler(\DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Handler\HandlerInterface $handler)
    {
    ...
    {
        if (!$this->handlers) {
            $this->pushHandler(new \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Handler\StreamHandler('php://stderr', static::DEBUG));
        }
