 ...
 */
class HipChatHandler extends \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Handler\SocketHandler
{
    /**
     * Use API version 1
     */
    ...
    protected function getAlertColor($level)
    {
        switch (true) {
            ...
            case $level >= \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Logger::INFO:
                return 'green';
            case $level == \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Logger::DEBUG:
                return 'gray';
            default:
                return 'yellow';
        }
