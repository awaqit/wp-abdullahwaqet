...
class SignalHandler
{
    ...
    public function registerSignalHandler($signo, $level = \DeliciousBrains\WP_Offload_Media\Gcp\Psr\Log\LogLevel::CRITICAL, $callPrevious = true, $restartSyscalls = true, $async = true)
    {
    ...
    public function handleSignal($signo, array $siginfo = null)
    {
        ...
        $level = isset($this->signalLevelMap[$signo]) ? $this->signalLevelMap[$signo] : \DeliciousBrains\WP_Offload_Media\Gcp\Psr\Log\LogLevel::CRITICAL;
