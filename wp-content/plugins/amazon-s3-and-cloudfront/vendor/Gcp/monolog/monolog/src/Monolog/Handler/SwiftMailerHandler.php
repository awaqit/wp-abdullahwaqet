 ...
 * @author Gyula Sallai
 */
class SwiftMailerHandler extends \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Handler\MailHandler
{
    protected $mailer;
     ...
     */
    public function __construct(\Swift_Mailer $mailer, $message, $level = \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Logger::ERROR, $bubble = true)
    {
    ...
    {
        return new \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Formatter\LineFormatter($format);
    }
    /**
