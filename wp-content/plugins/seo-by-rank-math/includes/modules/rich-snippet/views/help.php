...
use RankMath\KB;
?>
<h3><?php esc_html_e( 'Schema (Structured Data)', 'rank-math' ); ?></h3>
...
<p><?php esc_html_e( 'For instance, there are "schemas" for articles, videos, businesses, events, products, and recipes.', 'rank-math' ); ?></p>
...
<p><?php esc_html_e( 'Both of these benefits make Rich Snippets extremely attractive. But Google can\'t display rich results unless it understands your content type. And it needs your help.', 'rank-math' ); ?></p>
...
<p><a href="<?php KB::the( 'rich-snippets' ); ?>" target="_blank"><?php esc_html_e( 'Click here to read full Schema tutorial', 'rank-math' ); ?></a></p>
