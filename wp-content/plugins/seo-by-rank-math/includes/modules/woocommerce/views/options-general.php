...
$cmb->add_field(
	[
		...
		'desc'    => sprintf(
			...
			'<br /><code>WordPress Dashboard > Settings > Permalinks > Product permalinks Example: default: /product/accessories/action-figures/acme/ - becomes: /accessories/action-figures/acme/</code>'
		),
		'default' => 'off',
	]
);
