...
<form class="rank-math-export-form cmb2-form" action="" method="post">
	...
	<table class="form-table">
		<tbody>
			<tr>
				<th scope="row"><label for="status"><?php esc_html_e( 'Panels', 'rank-math' ); ?></label></th>
				<td>
	...
	<footer>
		...
		<button type="submit" class="button button-primary button-xlarge"><?php esc_html_e( 'Export', 'rank-math' ); ?></button>
	</footer>
